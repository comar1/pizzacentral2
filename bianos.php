...
<html lang="en" class="h-100">
  <head>
    ...
    <title>Pizza Central 2 - Bianos</title>
...
<?php
  ...
  $result = $mysqli->query("SELECT * FROM bianos") or die($mysqli->error);
  //pre_r($result);
  ?>

<main role="main" class="flex-shrink-0">
  <div class="container">
    <h1 class="mt-5" style="text-align: center;">BIANO'S PIZZA</h1>
      ...
      <div class="col" style="height:150px">
        ...
        <div class="row" style="padding-left:15px">
          ...
          <div class="col-3" style="align-items:right"> 
            <a href="bianos.php?addtobianos=<?php echo $row['id']; ?>" class="btn btn-info">Add to Cart</a>
          </div>
        </div>
      </div>
    </div>
